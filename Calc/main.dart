...
class _SIFormState extends State<SIForm> {
  ...
  var _currencies = ['HTG','Dollars','Pesos','Euro'];
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              decoration: InputDecoration(
                labelText: 'Principal',
                hintText: 'Enter Principal e.g. 1230',
...
,
  ...
  Widget getImageAsset(){
    ...
    AssetImage assetImage = AssetImage('images/softmatech.png');
    Image image = Image(image: assetImage, width: 250.0,height: 200.0,);

    return Container(child: image,margin: EdgeInsets.all(_minimumPadding * 2),);
  }
